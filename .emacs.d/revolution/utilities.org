...
## Last update Fri Jan 30 10:02:56 2026 @author Glider
## ======================================================================
#+END_COMMENT
...
#+NAME: Paging Which-key help
#+BEGIN_SRC emacs-lisp :lexical t

;; ;;	  (which-key--pages-obj ;; contient la liste formatée et paginée)
;; (defun er-setup-paging-which-key ()
;;   "Setup minibuffer to paging with TAB key."
;;   (when which-key--pages-obj
;;     (let ((pages-struct which-key--pages-obj))
;;       (which-key--show-page )
;;       (message "[1] Hello world [%s]" (which-key--process-page- pages-struct)))))

;; (add-hook 'which-key-init-buffer-hook 'er-setup-paging-which-key)
